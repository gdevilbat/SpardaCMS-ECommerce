@can('menu-ecommerce')
    <li class="m-menu__item m-menu__item--submenu {{in_array(Route::current()->getName(), ['product', 'product-category', 'product-tag']) ? 'm-menu__item--expanded m-menu__item--open' : ''}}" aria-haspopup="true" m-menu-submenu-toggle="hover">
        ...
        <div class="m-menu__submenu "><span class="m-menu__arrow"></span>
            <ul class="m-menu__subnav">
                ...
                <li class="m-menu__item  {{Route::current()->getName() ==  'product-tag' ? 'm-menu__item--active' : ''}}" aria-haspopup="true"><a href="{{action('\Gdevilbat\SpardaCMS\Modules\Ecommerce\Http\Controllers\ShopeeController@shopeePromotion')}}" class="m-menu__link "><i class="m-menu__link-bullet m-menu__link-bullet--dot"><span></span></i><span class="m-menu__link-text">Shopee Promotion</span></a></li>
            </ul>
        </div>
    </li>
@endcan