...
class ProductRepository extends AbstractRepository
{
    ...
    public function validatePost(Request $request)
    {
        ...
        $validator->addRules([
                ...
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.shop_id' => 'required_with:meta.'.ProductMeta::LAZADA_SUPPLIER.'.slug',
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.slug' => 'required_with:meta.'.ProductMeta::LAZADA_SUPPLIER.'.shop_id',
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.product_id' => 'required_with:meta.'.ProductMeta::LAZADA_SUPPLIER.'.slug',
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.children.*.product_id' => 'required|required_with:meta.'.ProductMeta::LAZADA_SUPPLIER.'.slug',
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.children' => 'required_if:meta.'.ProductMeta::LAZADA_SUPPLIER.'.is_variant,true',
                'meta.'.ProductMeta::LAZADA_SUPPLIER.'.product_id' => 'required_if:meta.'.ProductMeta::LAZADA_SUPPLIER.'.is_variant,true',
                ...
                'meta.'.ProductMeta::LAZADA_STORE.'.shop_id' => 'required_with:meta.'.ProductMeta::LAZADA_STORE.'.slug',
                'meta.'.ProductMeta::LAZADA_STORE.'.slug' => 'required_with:meta.'.ProductMeta::LAZADA_STORE.'.shop_id',
                'meta.'.ProductMeta::LAZADA_STORE.'.product_id' => 'required_with:meta.'.ProductMeta::LAZADA_STORE.'.slug',
                'meta.'.ProductMeta::LAZADA_STORE.'.children.*.product_id' => 'required|required_with:meta.'.ProductMeta::LAZADA_STORE.'.slug',
                'meta.'.ProductMeta::LAZADA_STORE.'.children' => 'required_if:meta.'.ProductMeta::LAZADA_STORE.'.is_variant,true',
                'meta.'.ProductMeta::LAZADA_STORE.'.product_id' => 'required_if:meta.'.ProductMeta::LAZADA_STORE.'.is_variant,true',
                ...
                'meta.'.ProductMeta::PRODUCT_VARIANT.'.children.*.price' => 'numeric|required',
                'meta.'.ProductMeta::PRODUCT_VARIANT.'.children.*.sale' => 'numeric|required|lt:meta.'.ProductMeta::PRODUCT_VARIANT.'.children.*.price',
