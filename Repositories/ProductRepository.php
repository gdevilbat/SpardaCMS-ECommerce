...
class ProductRepository extends AbstractRepository
{
    ...
    public function validatePost(Request $request)
    {
        ...
        $validator->addRules([
                ...
                'meta.'.ProductMeta::TOKPED_SUPPLIER.'.slug' => 'required_with:meta.'.ProductMeta::TOKPED_SUPPLIER.'.merchant,meta.'.ProductMeta::TOKPED_SUPPLIER.'.children.*.product_id',
                'meta.'.ProductMeta::TOKPED_SUPPLIER.'.children.*.product_id' => 'required',
                'meta.'.ProductMeta::TOKPED_SUPPLIER.'.children' => 'required_with:meta.'.ProductMeta::TOKPED_SUPPLIER.'.is_variant',
                'meta.'.ProductMeta::SHOPEE_SUPPLIER.'.shop_id' => 'required_with:meta.'.ProductMeta::SHOPEE_SUPPLIER.'.product_id',
                'meta.'.ProductMeta::SHOPEE_SUPPLIER.'.product_id' => 'required_with:meta.'.ProductMeta::SHOPEE_SUPPLIER.'.shop_id,meta.'.ProductMeta::SHOPEE_SUPPLIER.'.children.*.product_id',
                'meta.'.ProductMeta::SHOPEE_SUPPLIER.'.children.*.product_id' => 'required|required_with:meta.'.ProductMeta::SHOPEE_SUPPLIER.'.product_id',
                'meta.'.ProductMeta::SHOPEE_SUPPLIER.'.children' => 'required_with:meta.'.ProductMeta::SHOPEE_SUPPLIER.'.is_variant',
                'meta.'.ProductMeta::TOKPED_STORE.'.merchant' => 'required_with:meta.'.ProductMeta::TOKPED_STORE.'.slug',
                'meta.'.ProductMeta::TOKPED_STORE.'.slug' => 'required_with:meta.'.ProductMeta::TOKPED_STORE.'.merchant,meta.'.ProductMeta::TOKPED_STORE.'.children.*.product_id',
                'meta.'.ProductMeta::TOKPED_STORE.'.children.*.product_id' => 'required|required_with:meta.'.ProductMeta::TOKPED_STORE.'.slug',
                'meta.'.ProductMeta::TOKPED_STORE.'.children' => 'required_with:meta.'.ProductMeta::TOKPED_STORE.'.is_variant',
                'meta.'.ProductMeta::SHOPEE_STORE.'.shop_id' => 'required_with:meta.'.ProductMeta::SHOPEE_STORE.'.product_id',
                'meta.'.ProductMeta::SHOPEE_STORE.'.product_id' => 'required_with:meta.'.ProductMeta::SHOPEE_STORE.'.shop_id,meta.'.ProductMeta::SHOPEE_STORE.'.children.*.product_id',
                'meta.'.ProductMeta::SHOPEE_STORE.'.children.*.product_id' => 'required|required_with:meta.'.ProductMeta::SHOPEE_STORE.'.product_id',
                'meta.'.ProductMeta::SHOPEE_STORE.'.children' => 'required_with:meta.'.ProductMeta::SHOPEE_STORE.'.is_variant',
                'taxonomy.category' => 'required',
